export const FoodData = [
  {
    name: "Chennai",
    details: `Chennai's local cuisine consists of traditional South
        ...
        Pongal, Kesari, Payasam and much more.`,
  },
  {
    name: "Rameshwaram",
    details: `Rameswaram offers delicious and elaborate South-
  ...
  {
    name: "Kodaikanal",
    details: `Chocolates, Sandwiches, Brownies, cheeses and some
        ...
        Sweet pongal and lots Sambhar, Rasam, Paysam. Kesal
        more.Kodaikanal offers exquisite Tamil cuisine which includes
        idlis and dosas. Besides that, the local's favourite Tibetan
        dishes like momos and noodle soup are a must-try.`,
  },
  {
    name: "Ooty",
    details: `Ooty can be your trip through dream-like indulges of
    ...
    nes, as well as sandwiches, pizzas and hot breads. one may also try the
    relish North-Indian cuisines, Chinese cui vegetarian South-Indian platter here with essentials like Idi,Dosa, Chutney, Vada, Sambhar, Rasam, Upma, Sweet Pongal,
    Payassam, Kesari.`,
  },
  {
    name: "Kanyakumari",
    details: `In Kanyakumari, much of what is prepared is done so
    with a generous use of spices and an essential garnish of
    coconut. Hence, one can sense these two flavours distinctly in
    almost all the food here. Other than these, do enjoy deacies of freshly caught fishes, as well as typical South-Indian
  ...
  {
    name: "Kumbakonam",
    details: `Vegetarian food rules the roost here with pre-
    dominantly Tamil cuisines on offer. One can get authen
    South Indian cuisines which tickle your taste buds. Also
  ...
  {
    name: "Madurai",
    details: `Madurai is often referred to as the food capital of
  ...
  {
    name: "Yercaud",
    details: `Tamil Nadu people believe that serving food to another
    ...
    of Tamil Nadu is identified.`,
  },
  {
    name: "Hogenakkal",
    details: `Being a small hill station, Hogenakkal isn't spoilt for
    choices, when it comes to restaurants. However there are
    delicacies of the mountains that you can enjoy here,
    like ice creams and soups cert;`,
  },
  {
    name: "Theni",
    details: `The hotel that is now famous for its non ~ vegetarian
    dishes was started by Chinnaswamy and his wife Susheela, as a
    quaint idli shop, around two and a half decades ago. Now, the
    hotel has become a major landmark in Theni district.
    Interestingly, the hotel is named after the couple's son,
    Iyothis. The dishes are put together by 15 cooks, who are also
    day at 4 in the couple's close relatives. The cooks begin th
    ...
    great culinary heritage that hasn't failed to impressed foodies`,
  },
];
